        ...
        <div class="jumbotron">
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6" align="center">
              <img class="img-responsive" style="width:100%; max-width: 300px; height:100%; max-height:600px" width="207" height="26" src="img/kingdomcome.jpg">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
              ...
              <!--<h4>¡No te quedes sin la tuya!</h4>-->
                <ul style="font-size: 11pt">
                  <li><strong>Tomo de pasta dura DC</strong></li><!--Esto CAMBIA hasta-->
                  <li>DC Comics Presenta: Kingdom Come</li>
                  <li>Kingdome Come narra la historia de un mundo donde los superheroes hacen justicia por su propia cuenta sin tomar en cuenta como afectara esto al resto de los habitantes que dicen proteger. Tras estos hechos, superheroes retirados como Wonder Woman, Batman y Superman se ven obligados a regresar para poner orden en todo este caos.</li>
                  <li><strike><strong>Precio de portada $349</strong></strike></li><!--Aquí según el comic-->
                  <li><strong>PRECIO DE OFERTA $300</strong></li>
                </ul>
              <p align="right">
